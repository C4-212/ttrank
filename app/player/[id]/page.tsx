                                    ...
                                    <Flex
                                        ...
                                        <Flex
                                            ...
                                            <Flex
                                                ...
                                                <Text fontSize="12px" color="black">　({((playerData?.win || 0) + (playerData?.lose || 0)) === 0
                                                    ? "0.00"
                                                    : ((playerData?.win || 0) / ((playerData?.win || 0) + (playerData?.lose || 0)) * 100).toFixed(2)
                                                }%)</Text>
